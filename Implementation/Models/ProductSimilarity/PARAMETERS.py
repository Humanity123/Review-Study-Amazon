...
#######################################
#######################################
datasetName = "images_all"          # Name of the image directory, e.g. /data/myFashion_texture/
...
rf_maxEpochs      = 5                  # Number of training epochs. Set to 0 to skip DNN refinement
...
# Files
imgUrlsPath             = resourcesDir + "images_all.tsv"
